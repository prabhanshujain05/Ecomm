...
public class UserServiceImpl implements UserService {
	...
	public RestResponse userRegister(RegisterDto registerDto) throws Exception {
		...
		address.setAddress1(registerDto.getAddress().getAddress1());
		address.setAddress2(registerDto.getAddress().getAddress2());
		address.setAddressType(registerDto.getAddress().getAddressType());
		address.setContactNo(registerDto.getAddress().getContactNo());
		address.setPostalCode(registerDto.getAddress().getPostalCode());
		address.setDistrict(registerDto.getAddress().getDistrict());
